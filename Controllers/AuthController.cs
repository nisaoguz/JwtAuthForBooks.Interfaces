    ...
    public class AuthController : ControllerBase
    {
                ...
                var authClaims = new List<Claim>
        {
            ...
            new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString()),
                ...
                var (accessToken, refreshToken) = GetTokens(authClaims);

                var response = new UserLoginResponse
                {
                    AuthenticateResult = true,
                    AuthToken = accessToken,
                    AccessTokenExpireDate = DateTime.UtcNow.AddHours(7), // AccessToken süresini belirtin
        ...
        private (string AccessToken, string RefreshToken) GetTokens(List<Claim> authClaims)
        {
        ...
        {
            const int tokenLength = 32; // Refresh token uzunluðu (byte cinsinden)
...
namespace JwtAuthForBooks.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("register-admin")]
        public async Task<IActionResult> RegisterAdmin([FromBody] UserRegistrationRequest model)
        {
            var userExists = await _userManager.FindByNameAsync(model.UserName);
            if (userExists != null)
                return StatusCode(StatusCodes.Status500InternalServerError, new Response { Status = "Error", Message = "User already exists!" });
